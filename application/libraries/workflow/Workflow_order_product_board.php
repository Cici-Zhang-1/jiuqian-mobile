...
class Workflow_order_product_board {
    ...
    public function __call($name, $arguments){
        $Methods = array(
            'create', 'print_list', 'shear', 'shearing', 'sheared', 'electronic_saw', 'electronic_sawing', 'electronic_sawed', 're_electronic_saw', 're_shear', 'edge', 'edging', 'edged', 're_edge', 'punch', 'punched', 'punching', 're_punch', 'sscan',  'scanning', 'scanned', 're_scan', 'pack', 'packing', 'packed', 're_pack'
        );
