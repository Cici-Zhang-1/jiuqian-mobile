 ...
 * Time: 9:33
 */
class Punch_workflow extends Workflow_order_product_board_abstract {
    ...
    public function punching(){
        $this->_Workflow->edit_current_workflow(Workflow_order_product_board::$AllWorkflow['punching'], array('punch' => $this->_CI->session->userdata('uid')));
