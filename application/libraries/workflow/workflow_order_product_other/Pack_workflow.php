 ...
 * Time: 9:33
 */
class Pack_workflow extends Workflow_order_product_other_abstract {
    ...
    public function packing () {
        $this->_Workflow->edit_current_workflow(Workflow_order_product_other::$AllWorkflow['packing']);
    ...
    public function packed($arguments) {
        ...
        $this->_Workflow->edit_current_workflow(Workflow_order_product_other::$AllWorkflow['packed'], array('pack' => $GLOBALS['creator'], 'pack_datetime' => date('Y-m-d H:i:s')));
