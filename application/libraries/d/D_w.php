...
class D_w extends D_abstract{
    ...
    static $_CabinetStruct;
    private $_CabinetStructId;
    static $_BoardPlate;
    ...
    public function edit ($Save) {
        ...
        self::$_CabinetStruct = $this->_CI->input->post('struct', true);
        if (!empty(self::$_CabinetStruct)) {
            self::$_CabinetStruct = gh_escape(self::$_CabinetStruct);
            self::$_CabinetStruct['order_product_id'] = $this->_OderProductId;
            $this->_CabinetStructId = intval(trim(self::$_CabinetStruct['v']));
            unset(self::$_CabinetStruct['v']);
        }
     ...
     * 编辑柜体结构
     */
    private function _edit_order_product_cabinet_struct () {
        if (!empty($this->_CabinetStructId)) {
            $this->_CI->order_product_cabinet_struct_model->update(self::$_CabinetStruct, $this->_CabinetStructId);
        } else {
            $this->_CI->order_product_cabinet_struct_model->insert(self::$_CabinetStruct);
        }
    }
     ...
     */
    private function _get_cabinet_struct ($OrderProductId) {
        if (empty(self::$_CabinetStruct)) {
            if (!!($CabinetStruct = $this->_CI->order_product_cabinet_struct_model->select_one(array('order_product_id' => $OrderProductId)))) {
