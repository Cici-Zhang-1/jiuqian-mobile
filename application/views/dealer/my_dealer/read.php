 ...
 */
?>
	<div class="page-line" id="myDealer">
		<div class="my-tools col-md-12">
		    <div class="col-md-3">
				<div class="input-group" id="myDealerSearch" data-toggle="search" data-target="#myDealerTable">
	  		...
	  		<div class="col-md-offset-3 col-md-6 text-right" id="myDealerFunction">
	  			<div class="btn-group" role="group">
		    		<button type="button" class="btn btn-danger dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
		      			共选中<span id="myDealerTableSelected" data-num="">0</span>项
		      			<span class="caret"></span>
		    		</button>
		    		<ul class="dropdown-menu" role="menu" data-table="#myDealerTable">
		    		    <li><a href="javascript:void(0);" data-toggle="modal" data-target="#myDealerModal" data-action="<?php echo site_url('dealer/my_dealer/edit');?>" data-multiple=false><i class="fa fa-pencil"></i>&nbsp;&nbsp;编辑</a></li>
		      			<li role="separator" class="divider"></li>
		      			<li><a href="javascript:void(0);" data-toggle="child" data-target="#myDealerTable" data-action="<?php echo site_url('dealer/dealer_linker/index/read');?>" data-multiple=false><i class="fa fa-user"></i>&nbsp;&nbsp;联系人</a></li>
		      			<li><a href="javascript:void(0);" data-toggle="child" data-target="#myDealerTable" data-action="<?php echo site_url('dealer/dealer_delivery/index/read');?>" data-multiple=false><i class="fa fa-truck"></i>&nbsp;&nbsp;发货信息</a></li>
		      			<li role="separator" class="divider"></li>
		      			<li><a href="<?php echo site_url('dealer/dealer_owner/index/read');?>" data-toggle="child" data-target="#myDealerTable" data-multiple=false><i class="fa fa-hand-o-up"></i>&nbsp;&nbsp;属主</a></li>
		      			<li role="separator" class="divider"></li>
		      			<li><a href="<?php echo site_url('dealer/dealer_trace/index/read');?>" data-toggle="child" data-target="#myDealerTable" data-multiple=false><i class="fa fa-hand-o-right"></i>&nbsp;&nbsp;跟踪</a></li>
		    		</ul>
		  		</div>
		  		<button class="btn btn-primary" type="button" value="新增" data-toggle="modal" data-target="#myDealerAddModal" data-action="<?php echo site_url('dealer/my_dealer/add');?>"><i class="fa fa-plus"></i>&nbsp;&nbsp;新增</button>
	  			<button class="btn btn-default" data-toggle="refresh" type="button" value="刷新"><i class="fa fa-refresh"></i>&nbsp;&nbsp;刷新</button>
	  		</div>
		</div>
		<div class="my-table col-md-12" >
			<table class="table table-bordered table-hover table-responsive table-condensed" id="myDealerTable" data-load="<?php echo site_url('dealer/my_dealer/read');?>">
				<thead>
					<tr>
				...
				<tbody>
				    <tr class="loading"><td colspan="12">加载中...</td></tr>
					<tr class="no-data"><td colspan="12">没有数据</td></tr>
			      	<tr class="model">
	...
	<div class="modal fade" id="myDealerModal" tabindex="-1" role="dialog" aria-labelledby="myDealerModalLabel" aria-hidden="true">
  		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				<form class="form-horizontal" id="myDealerForm" action="" method="post" role="form">
					<div class="modal-header">
	        			<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
	        			<h4 class="modal-title" id="myDealerModalLabel">编辑</h4>
	      			</div>
	...
	<div class="modal fade" id="myDealerAddModal" tabindex="-1" role="dialog" aria-labelledby="myDealerAddModalLabel" aria-hidden="true" >
	   <div class="modal-dialog modal-lg">
	       <div class="modal-content">
	           <form class="form-horizontal" id="myDealerAddForm" action="" method="post" role="form">
					<div class="modal-header">
	        			<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
	        			<h4 class="modal-title" id="myDealerAddModalLabel">编辑</h4>
	      			</div>
			      	<div class="modal-body">
			      	    <div class="form-group">
	...
	<script type="text/javascript">
		(function($, window, undefined){
				...
				$.ajax({
					...
					success: function(msg){
							if(msg.error == 0){
					            ...
					            $('#myDealerModal select[name="dcid"]').append(Item);
					            $('#myDealerAddModal select[name="dcid"]').append(Item);
					            $.sessionStorage('dealer_category', Item);
					        }
						}
				});
			}else{
				$('#myDealerModal select[name="dcid"]').append(SessionData);
	            $('#myDealerAddModal select[name="dcid"]').append(SessionData);
			}
				...
				$.ajax({
    				...
    				success: function(msg){
    						if(msg.error == 0){
    				            ...
    				            $('#myDealerModal select[name="pid"]').append(Item);
    				            $('#myDealerAddModal select[name="pid"]').append(Item);
    				            $.sessionStorage('payterms_pid', Item);
    				        }
    					}
				});
			}else{
				$('#myDealerModal select[name="pid"]').append(SessionData);
	            $('#myDealerAddModal select[name="pid"]').append(SessionData);
			}
				...
				$.ajax({
					...
					success: function(msg){
							if(msg.error == 0){
								...
								$('#myDealerModal select[name="aid"]').append(Item);
								$('#myDealerAddModal select[name="aid"]').append(Item);
								$('#myDealerAddModal select[name="daid"]').append(Item);
					        }
						}
				});
			}else{
				...
				$.ajax({
					...
					success: function(msg){
							if(msg.error == 0){
					            ...
					            $('#myDealerAddModal select[name="doid"]').append(Item);
					            $.sessionStorage('dealer_organization', Item);
					        }
						}
				});
			}else{
				$('#myDealerAddModal select[name="doid"]').append(SessionData);
			}
				...
				$.ajax({
					...
					success: function(msg){
							if(msg.error == 0){
					            ...
					            $('#myDealerAddModal select[name="lid"]').append(Item);
				...
				$.ajax({
					...
					success: function(msg){
							if(msg.error == 0){
					            ...
					            $('#myDealerAddModal select[name="omid"]').append(Item);
		    ...
		    $('div#myDealer').handle_page();
		    $('div#myDealerModal').handle_modal_000();
		    $('div#myDealerAddModal').handle_modal_000();
		})(jQuery);
	</script>