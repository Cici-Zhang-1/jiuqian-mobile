...
?>
        ...
        <script src="<?php echo base_url('source/js/jquery.cookie.js');?>"></script>
        ...
        <script type="text/javascript" src="<?php echo base_url('source/js/configs.js?v=1');?>"></script>
        <script type="text/javascript" src="<?php echo base_url('source/js/store.js?v=1');?>"></script>
        <script type="text/javascript" src="<?php echo base_url('source/js/home.js?v=1');?>"></script>
    </body>
</html>
