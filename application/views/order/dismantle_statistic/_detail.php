    ...
    <div class="my-print-data container-fluid">
        <div class="row">
            <div class="col-md-offset-2 col-md-8">
                <table class="table table-bordered table-striped table-hover table-responsive table-condensed" id="dismantleStatisticDetailTable">
                    <thead>
                    <tr>
...
END;
    ...
    <script>
        (function($){
            ...
            $('#dismantleStatisticDetailTable').tablesorter($(this).find('thead tr').getHeaders()); /** 表格排序*/
        })(jQuery);
    </script>
    </body>
</html>