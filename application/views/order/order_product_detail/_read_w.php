 ...
 */
?>
    <div class="page-line" id="orderProductDetailC" data-load="<?php echo site_url('order/order_product_detail/read');?>">
		<div class="my-tools col-md-12">
			<div class="col-md-3">
			    <div class="input-group" id="orderProductDetailCSearch">
    			    ...
    			    <input type="hidden" class="form-control" name="product" value="<?php echo $product;?>">
		      		...
		      		<span class="input-group-btn">
		        		<button class="btn btn-default" id="orderProductDetailCSearchBtn" type="button">Go!</button>
		      		</span>
		    	</div>
			</div>
	  		<div class="col-md-offset-3 col-md-6 text-right" id="orderProductDetailCFunction">
	  		    <div class="btn-group" role="group">
		    		<button type="button" class="btn btn-danger dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
		      			共选中<span id="orderProductDetailCTableSelected" data-num="">0</span>项
		      			<span class="caret"></span>
		    		</button>
		    		<ul class="dropdown-menu" role="menu" data-table="#orderProductDetailCTable">
		    		    <li><a href="javascript:void(0);" data-toggle="modal" data-target="#orderProductDetailCModal" data-action="<?php echo site_url('order/order_product_board_plate/edit');?>" data-multiple=false><i class="fa fa-pencil"></i>&nbsp;&nbsp;编辑</a></li>
		    		    <li class="divider" role="separator"></li>
		    		    <li><a href="javascript:void(0);" data-toggle="modal" data-target="#orderProductDetailCBoardModal" data-action="<?php echo site_url('order/order_product_board/edit');?>" data-multiple=true><i class="fa fa-pencil"></i>&nbsp;&nbsp;修改板材</a></li>
		    		</ul>
		  		</div>
		  		<div class="btn-group" role="group">
		    		...
		    		<ul class="dropdown-menu" role="menu" >
		    		    <li><a href="javascript:void(0);" data-toggle="child" data-action="<?php echo site_url('order/order_drawing/index/read?id='.$id);?>" ><i class="fa fa-photo"></i>&nbsp;&nbsp;图纸</a></li>
		    		    <li class="divider" role="separator"></li>
		...
		<div class="my-table col-md-12">
			<table class="table table-bordered table-striped table-hover table-responsive table-condensed" id="orderProductDetailCTable">
				<thead>
					<tr>
		...
		<div class="col-md-12" id="orderProductDetailCDrawing" ></div>
	</div>
	
	<div class="modal fade" id="orderProductDetailCModal" tabindex="-1" role="dialog" aria-labelledby="orderProductDetailCModalLabel" aria-hidden="true">
  		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				<form class="form-horizontal" id="orderProductDetailCForm" action="" method="post" role="form">
					<div class="modal-header">
	        			<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
	        			<h4 class="modal-title" id="orderProductDetailCModalLabel">编辑</h4>
	      			</div>
	...
	<div class="modal fade" id="orderProductDetailCBoardModal" tabindex="-1" role="dialog" aria-labelledby="orderProductDetailCBoardModalLabel" aria-hidden="true">
  		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				<form class="form-horizontal" id="orderProductDetailCBoardForm" action="" method="post" role="form">
					<div class="modal-header">
	        			<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
	        			<h4 class="modal-title" id="orderProductDetailCBoardModalLabel">修改板材</h4>
	      			</div>
			      	<div class="modal-body">
			      		<input type="hidden" name="selected" value="" />
			      		<div class="form-group">
	...
	<script>
		(function($){
			$('div#orderProductDetailC').handle_page();
		    $('div#orderProductDetailCModal').handle_modal_000();
		    $('div#orderProductDetailCBoardModal').handle_modal_000();
		})(jQuery);
	</script>