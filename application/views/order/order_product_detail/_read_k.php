 ...
 */
?>
    <div class="page-line" id="orderProductDetailK" data-load="<?php echo site_url('order/order_product_detail/read');?>">
		<div class="my-tools col-md-12">
			<div class="col-md-3">
			    <div class="input-group" id="orderProductDetailKSearch">
    			    <input type="hidden" name="id" value="<?php echo $id;?>">
    			    <input type="hidden" name="product" value="<?php echo $product;?>">
		      		<input type="text" class="form-control" name="keyword" data-toggle="search" placeholder="搜索">
		      		<span class="input-group-btn">
		        		<button class="btn btn-default" id="orderProductDetailKSearchBtn" type="button">Go!</button>
		      		</span>
		    	</div>
			</div>
	  		<div class="col-md-offset-3 col-md-6 text-right" id="orderProductDetailKFunction">
	  		    <div class="btn-group" role="group">
		    		<button type="button" class="btn btn-danger dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
		      			共选中<span id="orderProductDetailKTableSelected" data-num="">0</span>项
		      			<span class="caret"></span>
		    		</button>
		    		<ul class="dropdown-menu" role="menu" data-table="#orderProductDetailKTable">
		    		    <li><a href="javascript:void(0);" data-toggle="modal" data-target="#orderProductDetailKModal" data-action="<?php echo site_url('order/order_product_door_plate/edit');?>" data-multiple=false><i class="fa fa-pencil"></i>&nbsp;&nbsp;编辑</a></li>
		    		</ul>
		  		</div>
		  		<div class="btn-group" role="group">
		...
		<div class="my-table col-md-12">
			<table class="table table-bordered table-striped table-hover table-responsive table-condensed" id="orderProductDetailKTable">
				<thead>
					<tr>
	...
	<div class="modal fade" id="orderProductDetailKModal" tabindex="-1" role="dialog" aria-labelledby="orderProductDetailKModalModalLabel" aria-hidden="true">
  		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				<form class="form-horizontal" id="dealerForm" action="" method="post" role="form">
					<div class="modal-header">
	        			<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
	        			<h4 class="modal-title" id="orderProductDetailKModalLabel">编辑</h4>
	      			</div>
	...
	<script>
		(function($){
			$('div#orderProductDetailK').handle_page();
		    $('div#orderProductDetailKModal').handle_modal_000();
		})(jQuery);
	</script>