 ...
 */
?>
<div class="col-md-12" id="waitDelivery3Search" data-toggle="search" data-target="#waitDelivery3Table">
	<input type="text" class="form-control" name="keyword" placeholder="订单编号/经销商/业主/备注">
</div>
<div class="col-md-12">&nbsp;</div>
<div class="col-md-12" id="waitDelivery3">
    <table class="table table-bordered table-striped table-hover table-responsive table-condensed" id="waitDelivery3Table">
		<thead>
			<tr>
...
<tr>
	...
	<td >$value[icon]</td>
	<td ><a href="$OrderUrl" title="订单详情" data-toggle="floatover" data-target="#waitDelivery3Floatover" data-remote="$OrderRemote">$value[order_num]</a></td>
	<td >$value[payed]</td>
	<td >$value[sum]</td>
...
<div class="floatover hide" id="waitDelivery3Floatover"></div>