 ...
 */
?>
    <div class="page-line" id="orderProductBoardPlateW">
		<div class="my-tools col-md-12">
			<div class="col-md-3">
			    <div class="input-group" id="orderProductBoardPlateWSearch" data-toggle="search" data-target="orderProductBoardPlateWTable">
	  		...
	  		<div class="col-md-offset-3 col-md-6 text-right" id="orderProductBoardPlateWFunction">
		...
		<div class="my-table col-md-12">
			<table class="table table-bordered table-striped table-hover table-responsive table-condensed" id="orderProductBoardPlateWTable">
				<thead>
					<tr>
...
END;
	...
	<script>
		(function($){
			$('div#orderProductBoardPlateW').handle_page();
			$('#orderProductBoardPlateWTable').tablesorter($(this).find('thead tr').getHeaders()); /** 表格排序*/
		})(jQuery);
	</script>