        ...
        <div class="my-print-data container-fluid">
			<div class="row hidden-print">
				<div class="col-md-12">
					...
					<div class="col-md-6">
						<a class="btn btn-primary" href="<?php echo site_url('chart/print_list/index/read/print?form_style=_new&&id=' . $Info['opid']);?>" target="_blank"><i class="fa fa-refresh"></i>&nbsp;&nbsp;切换格式</a>
					</div>
				</div>
			</div>
...
<div class="my-box col-md-4">
    <p>订单编号: <span class="my-enhance-2">$Info[order_product_num]</span></p>
    <p>要求出厂: <span class="my-enhance-2">$Info[request_outdate]</span></p>
</div>
<div class="col-md-12">
    <p>柜体结构: 
END;
		  	        if(isset($Cabinet['CabinetStruct']) && is_array($Cabinet['CabinetStruct']) && count($Cabinet['CabinetStruct']) > 0){
		  	            $CabinetStruct = $Cabinet['CabinetStruct'];
		  	            $Html .= <<<END
    ...
    <table class="my-table-ensize table table-bordered table-condensed" >
        <thead>
            ...
            <tr>
                ...
                <th colspan="2">订单号:</th>
                <th colspan="3">$Info[order_product_num]</th>
            </tr>
            <tr>
            ...
            <tr><th colspan="10">$Info[order_product_remark]<br />$Info[remark]</th></tr>
            <tr>
