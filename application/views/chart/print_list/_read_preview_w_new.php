...
<div class="my-print-data container-fluid">
    <div class="row hidden-print">
        <div class="col-md-12">
            ...
            <div class="col-md-6">
                <a class="btn btn-primary" href="<?php echo site_url('chart/print_list/index/read/preview?id=' . $Info['opid']);?>" target="_blank"><i class="fa fa-refresh"></i>&nbsp;&nbsp;切换格式</a>
            </div>
        </div>
    </div>
    <div class="row">
