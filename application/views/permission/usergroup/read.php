	  		...
	  		<div class="col-md-offset-3 col-md-6 text-right" id="usergroupFunction">
	  			<div class="btn-group" role="group">
		    		...
		    		<ul class="dropdown-menu" role="menu" data-table="#usergroupTable">
		      			<li><a href="javascript:void(0);" data-toggle="modal" data-target="#usergroupModal" data-action="<?php echo site_url('permission/usergroup/edit');?>" data-multiple=false><i class="fa fa-pencil"></i>&nbsp;&nbsp;编辑</a></li>
		      			<li role="separator" class="divider"></li>
		      			<li><a href="javascript:void(0);" data-toggle="child" data-target="#usergroupTable" data-action="<?php echo site_url('permission/usergroup_role/index/read');?>" data-multiple=false><i class="fa fa-eye"></i>&nbsp;&nbsp;用户组角色</a></li>
		    		</ul>
		  		</div>
	  			<button class="btn btn-primary" type="button" value="新增" data-toggle="modal" data-target="#usergroupModal" data-action="<?php echo site_url('permission/usergroup/add');?>"><i class="fa fa-plus"></i>&nbsp;&nbsp;新增</button>
	  			<button class="btn btn-default" data-toggle="refresh" type="button" value="刷新"><i class="fa fa-refresh"></i>&nbsp;&nbsp;刷新</button>
	  			<a class="btn btn-default" data-toggle="backstage" data-target="#usergroupTable" href="<?php echo site_url('permission/usergroup/remove');?>" data-multiple=true ><i class="fa fa-trash-o"></i>&nbsp;&nbsp;删除</a>
	  		</div>
        </div>
		<div class="my-table col-md-12">
			<table class="table table-bordered table-hover table-responsive table-condensed" id="usergroupTable" data-load="<?php echo site_url('permission/usergroup/read');?>">
				<thead>
					<tr>
	...
	<script type="text/javascript">
		(function($, window, undefined){
			$.ajax({
				...
				type: 'get',
				dataType: 'json',
				url: '<?php echo site_url('permission/usergroup/read');?>',
