        ...
        <div class="my-tools col-md-12">
            <div class="col-md-3">
	  		...
	  		<div class="col-md-offset-3 col-md-6 text-right" id="roleFuncFunction">
	  		    <button class="btn btn-primary" data-toggle="save" data-target="#roleFuncTable" type="button" value="保存" data-action="<?php echo site_url('permission/role_func/edit');?>"><i class="fa fa-save"></i>&nbsp;&nbsp;保存</button>
