	  		...
	  		<div class="col-md-offset-3 col-md-6 text-right" id="menuFunction">
	  			<div class="btn-group" role="group">
		    		...
		    		<ul class="dropdown-menu" role="menu" data-table="#menuTable">
		      			<li><a id="menuEdit" href="javascript:void(0);" data-toggle="modal" data-target="#menuModal" data-action="<?php echo site_url('manage/menu/edit');?>" data-multiple=false><i class="fa fa-pencil"></i>&nbsp;&nbsp;编辑</a></li>
		    		</ul>
		  		</div>
	  			<button class="btn btn-primary" type="button" value="新增" data-toggle="modal" data-target="#menuModal" data-action="<?php echo site_url('manage/menu/add');?>"><i class="fa fa-plus"></i>&nbsp;&nbsp;新增</button>
	  			<button class="btn btn-default" data-toggle="refresh" type="button" value="刷新"><i class="fa fa-refresh"></i>&nbsp;&nbsp;刷新</button>
	  			<a class="btn btn-default" data-toggle="backstage" data-target="#menuTable" href="<?php echo site_url('manage/menu/remove');?>" data-multiple=true><i class="fa fa-trash-o"></i>&nbsp;&nbsp;删除</a>
	  		</div>
        </div>
		<div class="my-table col-md-12">
			<table class="table table-bordered table-hover table-responsive table-condensed" id="menuTable" data-load="<?php echo site_url('manage/menu/read');?>">
				<thead>
					<tr>
	...
	<script>
		(function($){
			$.ajax({
				...
				dataType: 'json',
				data: {parent: 0},
				url: '<?php echo site_url('manage/menu/read');?>',
