...
class PHPExcel_Writer_Excel5 extends PHPExcel_Writer_Abstract implements PHPExcel_Writer_IWriter
{
	...
	private function _writeDocumentSummaryInformation(){
		...
		$dataSection[] = array('summary'=> array('Package' => 'V', 'data' => 0x01),
							   'offset' => array('Package' => 'V'),
							   'type' 	=> array('Package' => 'V', 'data' => 0x02), // 2 byte signed integer
		...
		if($this->_phpExcel->getProperties()->getCategory()){
			...
			$dataSection[] = array('summary'=> array('Package' => 'V', 'data' => 0x02),
								   'offset' => array('Package' => 'V'),
								   'type' 	=> array('Package' => 'V', 'data' => 0x1E),
		...
		$dataSection[] = array('summary'=> array('Package' => 'V', 'data' => 0x17),
							   'offset' => array('Package' => 'V'),
							   'type' 	=> array('Package' => 'V', 'data' => 0x03),
							   'data'	=> array('Package' => 'V', 'data' => 0x000C0000));
		$dataSection_NumProps++;
		// GKPIDDSI_SCALE : FALSE
		$dataSection[] = array('summary'=> array('Package' => 'V', 'data' => 0x0B),
							   'offset' => array('Package' => 'V'),
							   'type' 	=> array('Package' => 'V', 'data' => 0x0B),
		...
		$dataSection[] = array('summary'=> array('Package' => 'V', 'data' => 0x10),
							   'offset' => array('Package' => 'V'),
							   'type' 	=> array('Package' => 'V', 'data' => 0x0B),
							   'data'	=> array('data' => false));
		$dataSection_NumProps++;
		// GKPIDDSI_SHAREDOC : FALSE
		$dataSection[] = array('summary'=> array('Package' => 'V', 'data' => 0x13),
							   'offset' => array('Package' => 'V'),
							   'type' 	=> array('Package' => 'V', 'data' => 0x0B),
							   'data'	=> array('data' => false));
		$dataSection_NumProps++;
		...
		$dataSection[] = array('summary'=> array('Package' => 'V', 'data' => 0x16),
							   'offset' => array('Package' => 'V'),
							   'type' 	=> array('Package' => 'V', 'data' => 0x0B),
							   'data'	=> array('data' => false));
		$dataSection_NumProps++;
		...
		$dataSection[] = array('summary'=> array('Package' => 'V', 'data' => 0x0D),
							   'offset' => array('Package' => 'V'),
							   'type' 	=> array('Package' => 'V', 'data' => 0x101E),
							   'data'	=> array('data' => $dataProp, 'length' => strlen($dataProp)));
		$dataSection_NumProps++;
        ...
        $dataSection[] = array('summary'=> array('Package' => 'V', 'data' => 0x0C),
        					   'offset' => array('Package' => 'V'),
        					   'type' 	=> array('Package' => 'V', 'data' => 0x100C),
        					   'data'	=> array('data' => $dataProp, 'length' => strlen($dataProp)));
        $dataSection_NumProps++;
		...
		foreach ($dataSection as $dataProp){
			// Summary
			$dataSection_Summary .= pack($dataProp['summary']['Package'], $dataProp['summary']['data']);
			// Offset
			$dataSection_Summary .= pack($dataProp['offset']['Package'], $dataSection_Content_Offset);
			// DataType
			$dataSection_Content .= pack($dataProp['type']['Package'], $dataProp['type']['data']);
			// Data
	...
	private function _writeSummaryInformation(){
		...
		if($this->_phpExcel->getProperties()->getTitle()){
			...
			$dataSection[] = array('summary'=> array('Package' => 'V', 'data' => 0x02),
								   'offset' => array('Package' => 'V'),
								   'type' 	=> array('Package' => 'V', 'data' => 0x1E), // null-terminated string prepended by dword string length
								   'data'	=> array('data' => $dataProp, 'length' => strlen($dataProp)));
			$dataSection_NumProps++;
		}
		//	Subject
		if($this->_phpExcel->getProperties()->getSubject()){
			...
			$dataSection[] = array('summary'=> array('Package' => 'V', 'data' => 0x03),
								   'offset' => array('Package' => 'V'),
								   'type' 	=> array('Package' => 'V', 'data' => 0x1E), // null-terminated string prepended by dword string length
								   'data'	=> array('data' => $dataProp, 'length' => strlen($dataProp)));
			$dataSection_NumProps++;
		...
		if($this->_phpExcel->getProperties()->getCreator()){
			...
			$dataSection[] = array('summary'=> array('Package' => 'V', 'data' => 0x04),
								   'offset' => array('Package' => 'V'),
								   'type' 	=> array('Package' => 'V', 'data' => 0x1E), // null-terminated string prepended by dword string length
								   'data'	=> array('data' => $dataProp, 'length' => strlen($dataProp)));
			$dataSection_NumProps++;
		...
		if($this->_phpExcel->getProperties()->getKeywords()){
			...
			$dataSection[] = array('summary'=> array('Package' => 'V', 'data' => 0x05),
								   'offset' => array('Package' => 'V'),
								   'type' 	=> array('Package' => 'V', 'data' => 0x1E), // null-terminated string prepended by dword string length
								   'data'	=> array('data' => $dataProp, 'length' => strlen($dataProp)));
			$dataSection_NumProps++;
		...
		if($this->_phpExcel->getProperties()->getDescription()){
			...
			$dataSection[] = array('summary'=> array('Package' => 'V', 'data' => 0x06),
								   'offset' => array('Package' => 'V'),
								   'type' 	=> array('Package' => 'V', 'data' => 0x1E), // null-terminated string prepended by dword string length
								   'data'	=> array('data' => $dataProp, 'length' => strlen($dataProp)));
			$dataSection_NumProps++;
		...
		if($this->_phpExcel->getProperties()->getLastModifiedBy()){
			...
			$dataSection[] = array('summary'=> array('Package' => 'V', 'data' => 0x08),
								   'offset' => array('Package' => 'V'),
								   'type' 	=> array('Package' => 'V', 'data' => 0x1E), // null-terminated string prepended by dword string length
								   'data'	=> array('data' => $dataProp, 'length' => strlen($dataProp)));
			$dataSection_NumProps++;
		...
		if($this->_phpExcel->getProperties()->getCreated()){
			...
			$dataSection[] = array('summary'=> array('Package' => 'V', 'data' => 0x0C),
								   'offset' => array('Package' => 'V'),
								   'type' 	=> array('Package' => 'V', 'data' => 0x40), // Filetime (64-bit value representing the number of 100-nanosecond intervals since January 1, 1601)
		...
		$dataSection[] = array('summary'=> array('Package' => 'V', 'data' => 0x13),
							   'offset' => array('Package' => 'V'),
							   'type' 	=> array('Package' => 'V', 'data' => 0x03), // 4 byte signed integer
