 ...
 * 优化列表
 */
class Pre_optimize extends MY_Controller{
    ...
    public function read(){
        ...
        $Data = array();
        if(!($Data = $this->order_product_board_model->select_pre_optimize($this->_Search))){
    ...
    public function pre_download () {
        if ($this->_pre_handle()) {
            ...
            if (!!($Query = $this->order_product_board_plate_model->select_pre_optimize($V))) {
