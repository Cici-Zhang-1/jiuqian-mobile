 ...
 * @des
 */
class Order_product_board_wood extends CWDMS_Controller{
    ...
    public function __construct(){
        parent::__construct();
        log_message('debug', 'Controller Order/Order_product_board_wood Start !');
    ...
    private function _read(){
        ...
        if($this->_Id && $this->_Product){
            ...
            $Data['BoardWood'] = $this->d_dismantle->read_detail('board_wood', $this->_Id);
