 ...
 * 包装扫描详情
 */
class Pack_detail extends CWDMS_Controller{
    ...
    public function __construct(){
        ...
        log_message('debug', 'Controller Pack/Pack_detail Start!');
    }
    ...
    private function _read(){
        ...
        if($Id > 0){
            $Data = array('Id' => $Id);
            if(!!($Data['Plate'] = $this->order_product_board_plate_model->select_scan_list($Id))){
                $this->Success = '获取扫描列表成功';
