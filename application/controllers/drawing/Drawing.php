...
class Drawing extends MY_Controller {
    public function __construct() {
        parent::__construct();
        log_message('debug', 'Controller drawing/Drawing __construct Start!');
    ...
    */
    ...
    public function add() {
        if ($this->_do_form_validation()) {
            ...
            if(!!($NewId = $this->drawing_model->insert($Post))) {
    ...
    */
    public function edit() {
        if ($this->_do_form_validation()) {
            ...
            $Where = $Post['v'];
            unset($Post['v']);
            if(!!($this->drawing_model->update($Post, $Where))){
    ...
    public function remove() {
        ...
        if ($this->_do_form_validation()) {
            ...
            if ($this->drawing_model->delete($Where)) {
