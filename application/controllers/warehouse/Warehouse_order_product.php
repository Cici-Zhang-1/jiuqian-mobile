    ...
    */
    ...
    public function add()
    {
        ...
        if ($this->_do_form_validation()) {
            ...
            if(!!($Cid = $this->warehouse_order_product_model->insert($Post))) {
    ...
    */
    public function edit() {
        if ($this->_do_form_validation()) {
            ...
            $Where = $Post['v'];
            unset($Post['v']);
            if(!!($this->warehouse_order_product_model->update($Post, $Where))){
    ...
    public function remove() {
        if ($this->_do_form_validation()) {
            ...
            if ($this->warehouse_order_product_model->delete($Where)) {
