...
class Card_setting extends MY_Controller {
    public function __construct() {
        ...
        $this->load->model('data/card_setting_model');
    }
    ...
    */
    ...
    public function read () {
        ...
        $Data = array();
        if(!($Data = $this->card_setting_model->select($this->_Search))){
    ...
    public function add()
    {
        ...
        if ($this->_do_form_validation()) {
            ...
            if(!!($Cid = $this->card_setting_model->insert($Post))) {
    ...
    */
    public function edit() {
        if ($this->_do_form_validation()) {
            ...
            $Where = $Post['selected'];
            unset($Post['selected']);
            if(!!($this->card_setting_model->update($Post, $Where))){
    ...
    public function remove() {
        if ($this->_do_form_validation()) {
            ...
            if ($this->card_setting_model->delete($Where)) {
