...
class Configs extends MY_Controller {
    ...
    public function __construct() {
        parent::__construct();
        log_message('debug', 'Controller data/Configs __construct Start!');
    ...
    */
    ...
    public function read () {
        ...
        $Data = array();
        if(!($Data = $this->configs_model->select($this->_Search))){
    ...
    public function add() {
        if ($this->_do_form_validation()) {
            ...
            if(!!($NewId = $this->configs_model->insert($Post))) {
    ...
    */
    public function edit() {
        if ($this->_do_form_validation()) {
            ...
            $Where = $Post['v'];
            unset($Post['v']);
            if(!!($this->configs_model->update($Post, $Where))){
    ...
    public function remove() {
        ...
        if ($this->_do_form_validation()) {
            ...
            if ($this->configs_model->delete($Where)) {
