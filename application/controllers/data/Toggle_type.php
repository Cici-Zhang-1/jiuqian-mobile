...
class Toggle_type extends MY_Controller {
    ...
    */
    ...
    public function read () {
        ...
        $Data = array();
        if(!($Data = $this->toggle_type_model->select($this->_Search))){
    ...
    public function add()
    {
        ...
        if ($this->_do_form_validation()) {
            ...
            if(!!($Cid = $this->toggle_type_model->insert($Post))) {
    ...
    */
    public function edit() {
        if ($this->_do_form_validation()) {
            ...
            $Where = $Post['selected'];
            unset($Post['selected']);
            if(!!($this->toggle_type_model->update($Post, $Where))){
    ...
    public function remove() {
        if ($this->_do_form_validation()) {
            ...
            if ($this->toggle_type_model->delete($Where)) {
