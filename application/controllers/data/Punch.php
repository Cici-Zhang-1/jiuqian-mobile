...
class Punch extends MY_Controller {
    public function __construct() {
        parent::__construct();
        log_message('debug', 'Controller data/Punch __construct Start!');
        $this->load->model('data/punch_model');
    }
    ...
    */
    ...
    public function add() {
        if ($this->_do_form_validation()) {
            ...
            if($this->punch_model->insert($Post) !== false) {
    ...
    */
    public function edit() {
        if ($this->_do_form_validation()) {
            ...
            $Where = $Post['v'];
            unset($Post['v']);
            if(!!($this->punch_model->update($Post, $Where))){
    ...
    public function remove() {
        ...
        if ($this->_do_form_validation()) {
            ...
            if ($this->punch_model->delete($Where)) {
