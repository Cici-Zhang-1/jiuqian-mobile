...
class Out_method extends MY_Controller {
    public function __construct() {
        parent::__construct();
        log_message('debug', 'Controller data/Out_method __construct Start!');
    ...
    */
    ...
    public function read () {
        ...
        $Data = array();
        if(!($Data = $this->out_method_model->select($this->_Search))){
    ...
    public function add() {
        if ($this->_do_form_validation()) {
            ...
            if($this->out_method_model->insert($Post) !== false) {
