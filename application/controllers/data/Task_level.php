...
class Task_level extends MY_Controller {
    public function __construct() {
        parent::__construct();
        log_message('debug', 'Controller data/Task_level __construct Start!');
    ...
    */
    ...
    public function read () {
        ...
        $Data = array();
        if(!($Data = $this->task_level_model->select($this->_Search))){
    ...
    public function add() {
        if ($this->_do_form_validation()) {
            ...
            if(!!($NewId = $this->task_level_model->insert($Post))) {
