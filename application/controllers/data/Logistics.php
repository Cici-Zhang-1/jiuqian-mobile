...
class Logistics extends MY_Controller {
    public function __construct() {
        parent::__construct();
        log_message('debug', 'Controller data/Logistics __construct Start!');
    ...
    */
    ...
    public function read () {
        ...
        $Data = array();
        if(!($Data = $this->logistics_model->select($this->_Search))){
    ...
    public function add() {
        if ($this->_do_form_validation()) {
            ...
            if($this->logistics_model->insert($Post) !== false) {
