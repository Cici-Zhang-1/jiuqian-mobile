...
class Order_type extends MY_Controller {
    public function __construct() {
        parent::__construct();
        log_message('debug', 'Controller data/Order_type __construct Start!');
    ...
    */
    ...
    public function read () {
        ...
        $Data = array();
        if(!($Data = $this->order_type_model->select($this->_Search))){
    ...
    public function add() {
        if ($this->_do_form_validation()) {
            ...
            if(!!($NewId = $this->order_type_model->insert($Post))) {
