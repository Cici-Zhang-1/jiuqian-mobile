...
class Card extends MY_Controller {
    ...
    public function __construct() {
        parent::__construct();
        log_message('debug', 'Controller  __construct permission/Card Start!');
    ...
    public function read() {
        ...
        $Data = array();
        if(!($Data = $this->card_model->select($this->_Search))){
    ...
    public function add() {
        if ($this->_do_form_validation()) {
            ...
            if(!!($Fid = $this->card_model->insert($Post))) {
                $this->load->model('permission/role_card_model');
                $this->role_card_model->insert(array('role_v' => SUPER_NO, 'card_v' => $Fid));
